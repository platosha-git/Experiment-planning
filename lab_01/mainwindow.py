...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1214, 629)
        self.centralWidget = QtWidgets.QWidget(MainWindow)
        self.centralWidget.setObjectName("centralWidget")
        self.groupBox = QtWidgets.QGroupBox(self.centralWidget)
        self.groupBox.setGeometry(QtCore.QRect(10, 40, 251, 71))
        self.groupBox.setObjectName("groupBox")
        self.spinbox_intensivity_gen = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.spinbox_intensivity_gen.setGeometry(QtCore.QRect(120, 30, 121, 26))
        ...
        self.label_2.setGeometry(QtCore.QRect(0, 30, 115, 21))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(290, 40, 261, 91))
        ...
        self.spinbox_intensivity_oa = QtWidgets.QDoubleSpinBox(self.groupBox_2)
        ...
        self.spinbox_intensivity_oa_range.setGeometry(QtCore.QRect(420, 100, 121, 26))
        ...
        self.label_5.setGeometry(QtCore.QRect(10, 150, 168, 26))
        self.label_5.setObjectName("label_5")
        self.spinbox_time_model = QtWidgets.QDoubleSpinBox(self.centralWidget)
        self.spinbox_time_model.setGeometry(QtCore.QRect(190, 150, 121, 26))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Нормальное распределение"))
